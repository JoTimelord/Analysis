...
int main(int argc, char** argv)
{
    ...
    ONEFATJETCUT::initializeArbol(arbol);

    // Initialize Cutflow
    Cutflow cutflow = Cutflow(cli.output_name + "_Cutflow");
    ONEFATJETCUT::initializeCutflow(cutflow);
    ...
    Cut* lep_sel = new LambdaCut(
        ...
        [&]()
        {
            return ONEFATJETCUT::eq2ElectronsPtGt30(nt, arbol, cutflow);
        }
    );
    ...
    Cut* hbb_sel = new LambdaCut(
        ...
        [&]()
        {
            return ONEFATJETCUT::fatJetHbbScore(nt, arbol, cutflow);
        }
    );
    ...
    Cut* ak4_sel = new LambdaCut(
        ...
        [&]()
        {
            return ONEFATJETCUT::geq4JetsPtGt30(nt, arbol, cutflow);
        }
    );
    ...
    Cut* mjj_sel = new LambdaCut(
        ...
        [&]()
        {
            return ONEFATJETCUT::mjjGt500(nt, arbol, cutflow);
        }
    );
    ...
    Cut* deta_sel = new LambdaCut(
        ...
        [&]()
        {
            return ONEFATJETCUT::deltaEtaGt3(nt, arbol, cutflow);
        }
    );
    ...
    Cut* ST_sel = new LambdaCut(
        ...
        [&]()
        {
            return ONEFATJETCUT::stgeq950(nt, arbol, cutflow);
        }
    );
