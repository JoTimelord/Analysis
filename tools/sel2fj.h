...
bool TWOFATJETSCUT::geq2Fatjets(Nano& nt, Arbol& arbol, Cutflow& cutflow, double sd_mass=40, double pt=250, double maxdeta=2.5) {
    ...
    for (int j=0; j<fatjetindx.size(); j++) {
        ...
        if (this_xvqq > highestxvqq && this_indx != hbbindx) {
            xvqqindx=this_indx;
...
bool TWOFATJETSCUT::geq2JetsPtGt30(Nano& nt, Arbol& arbol, Cutflow& cutflow, double pt=30) {
    ...
    if (pass) {
        ...
        TWOFATJETSCUT::fillTree(nt, arbol, cutflow);
    }
    return pass;
}
...
void TWOFATJETSCUT::initializeArbol(Arbol& arbol_) {
    ...
    arbol_.newBranch<double>("sd_vbfjet_phi", -999.9);
    arbol_.newBranch<double>("sd_vbfjet_y", -999.9);
    ...
    arbol_.newBranch<double>("sd_lep_phi", -999.9);
    arbol_.newBranch<int>("ld_lep_ID", -999);
    arbol_.newBranch<int>("sd_lep_ID", -999);
    arbol_.newBranch<double>("mll", -999.9);
    arbol_.newBranch<double>("ptll", -999.9);
    arbol_.newBranch<double>("dRll", -999.9);
    arbol_.newBranch<double>("yll", -999.9);
    arbol_.newBranch<double>("dyll", -999.9);
    arbol_.newBranch<double>("met", -999.9);
    ...
    arbol_.newBranch<double>("hbb_phi", -999.9);
    arbol_.newBranch<double>("xbb_score", -999.9);
    arbol_.newBranch<double>("hbb_pnetmass", -999.9);
    arbol_.newBranch<double>("hbb_sdmass", -999.9);
    ...
    arbol_.newBranch<double>("xvqq_phi", -999.9);
...
void TWOFATJETSCUT::fillTree(Nano& nt, Arbol& arbol, Cutflow& cutflow) {
    ...
    arbol.setLeaf<double>("dyll",fabs(ldlep_p4.Rapidity()-sdlep_p4.Rapidity()));
    arbol.setLeaf<double>("yll",(ldlep_p4+sdlep_p4).Rapidity());
    // Hbb fatjet
    ...
    arbol.setLeaf<double>("xvqq_pt", V.Pt());
    ...
    arbol.setLeaf<double>("sd_vbfjet_y", sdvbfLV.Rapidity());
    ...
    arbol.setLeaf<double>("dyjj",fabs(ldvbfLV.Rapidity()-sdvbfLV.Rapidity()));
    arbol.setLeaf<double>("yjj",(sdvbfLV+ldvbfLV).Rapidity());
